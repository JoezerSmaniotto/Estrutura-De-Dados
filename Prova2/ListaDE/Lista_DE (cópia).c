...
BRIEFING GERAL
Nome: Here
Ramo: Serviços/ Multi app, que integra vários apps em um, também possui 
serviços próprios como como o setor de serviços (Saúde, Construção,Transporte,
Objetivo da empresa: facilitar a dia a dia do  usuário. 
Principais concorrentes: Rappi, GetNinjas, 99Frellas.


PROJETO

Qual o público-alvo atual ? Usuários de smartphone, na faixa etária de 17 a 45 anos. 
Quando o usuário procurando? Serviços, agilidade e segurança.
Quais são outros interesses e necessidades desse usuário? Como agilizar seu tempo, e encontrar serviços de qualidade.


OBJETIVOS DO SITE

Objetivo primário do site?  Atrair novos clientes, fornecer informação, lançar uma nova marca.
Quais são os objetivos secundários?Publicidade de produtos e serviços e recolher informação de possíveis usuários.
Quais conteúdos deverão ser inseridos em seu site? Informações de como funciona o app, e link para download.
Qual a imagem a ser transmitida para o usuário ? Moderno, clean, colorido, responsivo, funcional.